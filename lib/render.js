class Render {
    ...
    draw(player, level, camera, game, score) {
        ...
        html += `Depth:${game.depth} Health:${player.health} Weapon:${player.weapon.type} Score:${score.currentScore()}`;
    ...
    drawEnd(depth, score) {
        this.el.innerHTML = `You died<br/>You managed to get to level ${depth}<br/>with a score of ${score.currentScore()}<br/><br/>Press enter to restart`;
    }
}
